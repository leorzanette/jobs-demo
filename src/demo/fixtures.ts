...
>[] = [
  {
    id: "sug-stone-rejected",
    applicationId: "app-stone",
    gmailMessageId: "msg-demo-stone-1",
    suggestedStatus: "rejected",
    matchedKeyword: "infelizmente",
    emailFrom: "recrutamento@stone.com.br",
    emailSubject: "Atualização sobre sua candidatura — Software Engineer",
    emailSnippet:
      "Infelizmente, seguiremos com outras candidaturas para a vaga de Software Engineer na Stone.",
    status: "pending",
    createdAt: daysAgo(1),
    updatedAt: daysAgo(1),
  },
  {
    ...
    matchedKeyword: "proposta de oferta",
    emailFrom: "talentos@nubank.com.br",
    emailSubject: "Proposta de oferta — Backend Engineer",
    emailSnippet:
      "Temos o prazer de enviar a proposta de oferta para a posição de Backend Engineer no Nubank.",
    status: "pending",
    createdAt: daysAgo(0),
    updatedAt: daysAgo(0),
  },
